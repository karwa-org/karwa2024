...
Dès lors, vous voulez savoir le nombre ($x$) maximum de garde que vous pouvez neutraliser / éviter avant de vous échapper ainsi que le temps minimum qu'il vous faut pour échapper les $x$ gardes.
\begin{Input}
