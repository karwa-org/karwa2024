...
Vous voulez savoir le nombre ($x$) maximum de gardes que vous pouvez neutraliser / éviter avant de vous vous fassiez attraper ainsi que le temps minimum qu'il vous faut pour échapper aux $x$ gardes.
\begin{Input}
...
\begin{Output}
    Sortez un entier $x$, le nombre de gardes que vous pouvez neutraliser avant de vous échapper et un entier $m$ le temps minimum qu'il vous faut pour échapper aux $x$ gardes.
\end{Output}
