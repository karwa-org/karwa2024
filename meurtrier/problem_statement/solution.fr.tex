...
\begin{frame}
    est-ce que le noeud bleu à vu le noeuds vert ?
    \centering
            \begin{figure}%[H]
                \begin{tikzpicture}[>=stealth', shorten >=1pt, auto,
                    node distance=2.5cm, scale=1,
